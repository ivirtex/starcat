...
part 'model/orbiter.dart';
part 'model/orbiter_spacecraft_config.dart';
part 'model/orbiter_status.dart';
part 'model/pad.dart';
...
part 'model/starship_dashboard.dart';
part 'model/starship_dashboard_upcoming.dart';
