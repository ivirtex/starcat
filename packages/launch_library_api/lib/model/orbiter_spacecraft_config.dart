...
class OrbiterSpacecraftConfig {
  /// Returns a new [OrbiterSpacecraftConfig] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrbiterSpacecraftConfig &&
     other.id == id &&
     other.url == url &&
     other.name == name &&
     other.type == type &&
  ...
  /// Returns a new [OrbiterSpacecraftConfig] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OrbiterSpacecraftConfig? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrbiterSpacecraftConfig[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrbiterSpacecraftConfig[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OrbiterSpacecraftConfig> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OrbiterSpacecraftConfig>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OrbiterSpacecraftConfig.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OrbiterSpacecraftConfig> mapFromJson(dynamic json) {
    final map = <String, OrbiterSpacecraftConfig>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OrbiterSpacecraftConfig.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OrbiterSpacecraftConfig-objects as value to a dart map
  static Map<String, List<OrbiterSpacecraftConfig>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrbiterSpacecraftConfig>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrbiterSpacecraftConfig.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
