...
class AgencySerializerDetailed {
  ...
  bool operator ==(Object other) =>
      ...
      other is AgencySerializerDetailed &&
          other.id == id &&
          other.url == url &&
          other.name == name &&
          ...
          other.consecutiveSuccessfulLaunches ==
          ...
          other.consecutiveSuccessfulLandings ==
  ...
  int get hashCode =>
      ...
      (consecutiveSuccessfulLaunches == null
          ? 0
          : consecutiveSuccessfulLaunches!.hashCode) +
      ...
      (consecutiveSuccessfulLandings == null
          ? 0
          : consecutiveSuccessfulLandings!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.consecutiveSuccessfulLaunches != null) {
      json[r'consecutive_successful_launches'] =
          this.consecutiveSuccessfulLaunches;
    } else {
    ...
    if (this.consecutiveSuccessfulLandings != null) {
      json[r'consecutive_successful_landings'] =
          this.consecutiveSuccessfulLandings;
    } else {
  ...
  static AgencySerializerDetailed? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AgencySerializerDetailed[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AgencySerializerDetailed[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AgencySerializerDetailed(
        ...
        consecutiveSuccessfulLaunches:
            mapValueOfType<int>(json, r'consecutive_successful_launches'),
        ...
        consecutiveSuccessfulLandings:
            mapValueOfType<int>(json, r'consecutive_successful_landings'),
        ...
        launcherList: LauncherConfigDetailSerializerForAgency.listFromJson(
            json[r'launcher_list']),
        spacecraftList: SpacecraftConfigurationDetail.listFromJson(
            json[r'spacecraft_list']),
      );
    }
    return null;
  }

  static List<AgencySerializerDetailed> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AgencySerializerDetailed>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AgencySerializerDetailed.listFromJson(
          entry.value,
          growable: growable,
        );
      }
