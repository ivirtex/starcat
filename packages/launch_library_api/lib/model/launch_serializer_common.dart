...
class LaunchSerializerCommon {
  ...
  bool operator ==(Object other) =>
      ...
      other is LaunchSerializerCommon &&
          other.id == id &&
          other.url == url &&
          other.slug == slug &&
          other.name == name &&
          ...
          other.orbitalLaunchAttemptCountYear ==
              orbitalLaunchAttemptCountYear &&
          other.locationLaunchAttemptCountYear ==
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.agencyLaunchAttemptCountYear != null) {
      json[r'agency_launch_attempt_count_year'] =
          this.agencyLaunchAttemptCountYear;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "LaunchSerializerCommon[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "LaunchSerializerCommon[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return LaunchSerializerCommon(
        ...
        launchServiceProvider:
            AgencySerializerMini.fromJson(json[r'launch_service_provider'])!,
        ...
        orbitalLaunchAttemptCount:
            mapValueOfType<int>(json, r'orbital_launch_attempt_count'),
        locationLaunchAttemptCount:
            mapValueOfType<int>(json, r'location_launch_attempt_count'),
        padLaunchAttemptCount:
            mapValueOfType<int>(json, r'pad_launch_attempt_count'),
        agencyLaunchAttemptCount:
            mapValueOfType<int>(json, r'agency_launch_attempt_count'),
        orbitalLaunchAttemptCountYear:
            mapValueOfType<int>(json, r'orbital_launch_attempt_count_year'),
        locationLaunchAttemptCountYear:
            mapValueOfType<int>(json, r'location_launch_attempt_count_year'),
        padLaunchAttemptCountYear:
            mapValueOfType<int>(json, r'pad_launch_attempt_count_year'),
        agencyLaunchAttemptCountYear:
            mapValueOfType<int>(json, r'agency_launch_attempt_count_year'),
      );
    }
    return null;
  }

  static List<LaunchSerializerCommon> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<LaunchSerializerCommon>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = LaunchSerializerCommon.listFromJson(
          entry.value,
          growable: growable,
        );
      }
